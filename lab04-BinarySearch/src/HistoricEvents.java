 ...
 * timeline of events in the history of computing.  The timeline is
 * represented in the form of an array of {@link HistoricEvent} objects.
 *
 * This timeline is taken from the "Computer History Timeline" at:
 * http://www.history-timelines.org.uk/events-timelines/07-computer-
 * history-timeline.htm.  A more definitive, interactive timeline is
 * available from the Computer History Museum at:
...
public class HistoricEvents
{
    ...
    public static final HistoricEvent[] TIMELINE = {
        new HistoricEvent(60, "Heron of Alexandria",
            "Heron of Alexandria invents machines which follow a series "
            + "of instructions"),

        new HistoricEvent(724, "Liang Ling-Can",
            "Liang Ling-Can invents the first fully mechanical clock"),

        new HistoricEvent(1492, "Leonardo da Vinci",
        ...
        new HistoricEvent(1614, "John Napier",
        ...
        new HistoricEvent(1975, "Microsoft Corporation",
        ...
        new HistoricEvent(1983, "More than 10 million computers are in "
            + "use in the United States"),

        new HistoricEvent(1983, "Windows",
        ...
        new HistoricEvent(1988,
            "Over 45 million PCs are in use in the United States"),

        new HistoricEvent(1990, "Microsoft and IBM stop working together to "
            + "develop operating systems"),

        new HistoricEvent(1990,
        ...
        new HistoricEvent(1991, "The World Wide Web",
            "The World Wide Web is launched to the public on August 6, 1991"),

        new HistoricEvent(1993, "At the beginning of the year only 50 "
            + "World Wide Web servers are known to exist"),

        new HistoricEvent(1994, "The World Wide Web Consortium is founded "
