...
public class BinaryTree<T>
{
    ...
    public String toPreOrderString()
    {
        ...
        {
            builder += element + " " + left.toPreOrderString();
        }
        else if (left == null && right != null)
        {
            builder += element + " " + right.toPreOrderString();
        }
        else 
        { 
            builder += element + " " + left.toPreOrderString() + 
                    " " + right.toPreOrderString();
        }
        builder += ")";
        return builder;
    }
    ...
    public String toInOrderString()
    {
        ...
        {
            builder += left.toInOrderString() + " " + element + " ";
        }
        else if (left == null && right != null)
        {
            builder += element + " " + right.toInOrderString() + " ";
        }
        else 
        {
            builder += left.toInOrderString() + " " + element + 
                    " " + right.toInOrderString();
        }
        builder += ")";
        return builder;
    }
